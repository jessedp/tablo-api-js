...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">tablo-api documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse in" ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/Discover.html" data-type="entity-link">Discover</a>
                            </li>
                            <li class="link">
                                <a href="classes/Tablo.html" data-type="entity-link">Tablo</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse in" ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/ServerInfo.html" data-type="entity-link">ServerInfo</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
